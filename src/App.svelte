  ...
  const Constants = {
    ...
    reactionTable: [
      ...
      [
        ...
        ["S", "GhostWhite"],
        ["S", "GhostWhite"],
        ["R", "Al(OH)3", "I", "Ivory", "aluminium hydroxide"],
        ["S", "GhostWhite"],
        ["I", "Ivory"],
      ],
      [
      ...
      [
        ...
        ["S", "Blue"],
        ["S", "DarkGreen"],
        ["R", "CuI", "I", "Ivory", "copper(I) iodide"],
        ["I", "Blue"],
        ["I", "Black"],
        ["S", "Blue"],
        ["S", "DarkBlue"],
        ["R", "Cu2(OH)2CO3", "I", "SeaGreen", "copper(II) carbonate hydroxide"],
        ["S", "Blue"],
        ["I", "SkyBlue"],
      ],
      [
      ...
      [
        ...
        ["S", "GhostWhite"],
        ["I", "OrangeRed"],
        ["R", "HgO", "I", "Orange", "mercury(II) oxide"],
        ["I", "Ivory"],
        ["S", "GhostWhite"],
        ["S", "GhostWhite"],
        ["I", "Ivory"],
      ...
      [
        ...
        ["S", "Yellow"],
        ["S", "DarkBrown"],
        ["R", "FeI2", "S", "GhostWhite", "iron(II) iodide"],
        ["I", "DarkOrange"],
        ["S", "Red"],
        ["S", "Red"],
        ["S", "IndianRed"],
        ["R", "Fe2O3", "I", "Red", "iron(III) oxide"],
        ["S", "Orange"],
        ["I", "Peru"],
      ],
      [
